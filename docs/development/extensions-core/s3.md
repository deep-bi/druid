...
|`druid.s3.enableLegacyMd5`|Enables legacy MD5 checksum behavior for compatibility with S3 implementations that do not support newer checksum algorithms.|false|
